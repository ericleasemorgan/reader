...
if "id" not in input or "word" not in input :
	...
	print ( '''<html><head><title>Distant Reader - Word tree</title><meta name="viewport" content="width=device-width, initial-scale=1.0"><link rel="stylesheet" href="/reader/etc/style.css"></head><body><div class="header"><h1>Distant Reader - Word tree</h1></div><div class="col-3 col-m-3 menu"><ul><li><a href="/reader/home.html">Home</a></li><li><a href="/reader/about/">About</a></li></ul></div><div class="col-9 col-m-9"><p>Given a Distant Reader identifier and a word, this form returns a concordance-like visualization.</p><form method="GET" action="/reader/cgi-bin/wordtree.cgi">Identifier: <input type="text" name="id" value="ZebMBln" /><br />Word: <input type="text" name="word" value="love"/><br /><input type="submit" value="Word tree" /></form><div class="footer"><p style="text-align: right">Eric Lease Morgan &amp; Team Distant Reader<br />August 11, 2018</p></div></div></body></html>''' )
